...
namespace _3880_80_FlashStation.Visual.Gui
{
    class GuiCommunicationStatusBar : Gui
    {
        ...
        public override void Initialize(uint id, int xPosition, int yPosition)
        {
            ...
            GeneralGrid = GuiFactory.CreateGrid(XPosition, YPosition, HorizontalAlignment.Center, VerticalAlignment.Top, 20, 686);
            GeneralGrid.Children.Add(_plcStatusLabel = GuiFactory.CreateLabel("PlcStatusLabel", "Wrong Configuration!", 0, 0, HorizontalAlignment.Center, VerticalAlignment.Bottom, HorizontalAlignment.Right, 25, 686));
